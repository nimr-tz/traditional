<x-email.layout
    :title="$isReplacement ? 'Replacement presentation awaiting review' : 'New presentation awaiting review'"
    preheader="A presenter has uploaded a presentation file."
...
>
    ...
    <x-email.button :url="$reviewUrl">Review presentation</x-email.button>
